package com.laibao.netty.inaction.chapter8;
...
public class BootstrapClientWithOptionsAndAttrs {
    ...
    public void bootstrap() {
        ...
        final AttributeKey<Integer> idAttributeKey = AttributeKey.newInstance("id");
                ...
                .handler(
                        ...
                        new SimpleChannelInboundHandler<ByteBuf>() {
                            ...
                            public void channelRegistered(ChannelHandlerContext ctx)
                                ...
                                Integer idValue = ctx.channel().attr(idAttributeKey).get();
        ...
        //存储该 id 属性
        bootstrap.attr(idAttributeKey, 123456);
